...
class LxrCymbalEditor : public juce::AudioProcessorEditor
{
public:
    explicit LxrCymbalEditor (LxrCymbalProcessor&);
    ~LxrCymbalEditor() override;

    void paint   (juce::Graphics&) override;
    void resized() override;

private:
    LxrCymbalProcessor& proc;
    ...
    juce::Rectangle<int> carrierRect, fm1Rect, fm2Rect;
    juce::Rectangle<int> envRect, transRect, filterRect, outputRect;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LxrCymbalEditor)
};
