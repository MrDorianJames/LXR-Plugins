...
class LxrCymbalProcessor : public juce::AudioProcessor
{
public:
    LxrCymbalProcessor();
    ~LxrCymbalProcessor() override = default;
    ...
    const juce::String getName() const override{ return "LxrCymbal"; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LxrCymbalProcessor)
};
